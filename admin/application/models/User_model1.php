...
//	 {
	    ...
	    $pack_feature = $this->get_pack_fetures($getplandata->pack_fet);
...
//    		);
       ...
       //echo $this->db->last_query();exit();
        ...
        foreach($getdata as $query)
        {
            ...
            if(empty($get_total_point->toal_point)){$toal_points = "0";} else{$toal_points = $get_total_point->toal_point;}
             ...
             $data_array[] = array(
                "id"=> $query->id,
                "full_name"=>ucwords($query->full_name),
                "email"=> $query->email,
                "mobile"=> $query->mobile,
	...
	*/
	...
	public function app_get_notification_count($userid)
	{
	    ...
	    $event_count = $this->db->where('event_status','1')->get("events")->num_rows(); 
...
//	    print_r($query);die;
	...
	public function save_buddy_meet($buddymeetdetails){
	    ...
	    $data_insert=array(
	        ...
	        $this->add_notification($notification);
	            ...
	            $getusername = $this->getusernames($userdata['buddiesid']);
	      // $getrewardusername = $this->getusernames($user['userid']);
	...
	public function save_guest_event_invite($eventdata){
	    ...
	    $data_insert=array(
	           ...
	           "approval_status"=>$approval_status,
	           "payment_datetime"=>$eventdata['payment_datetime']
	        );

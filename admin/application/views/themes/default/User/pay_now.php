	  ...
	  <section class="pricing py-4">
	    <div class="row">
		  ...
		  <div class="col-lg-3">
		    <div class="card mb-5">
			  <div class="card-body">
			    <h5 class="card-title text-muted text-uppercase text-center"><?=my_esc_html($row->type)?></h5>
				...
				<p class="text-center">
				  <?php
				    if ($row->type == 'subscription') {
						if (!$row->auto_renew) {
							echo my_caption('payment_expire_in') . $row->recurring_interval_count . ' ' . $row->recurring_interval;
						}
						else {
							echo my_caption('payment_recurring_every') . $row->recurring_interval_count . ' ' . $row->recurring_interval;
						}
					}
			    ...
			    <hr>
				<ul class="fa-ul mb-4">
				  <li><span class="fa-li"><i class="fas fa-check"></i></span><?=my_esc_html($row->item_name)?></li>
				  <?php

	    ...
	    <div class="container">
          <div class="row justify-content-center">
            <div class="col-12 col-md-8 text-center">
              ...
              <p class="lead"><?=my_caption('front_pricing_slogan')?></p>
            </div>
          </div>
        </div>
                  ...
                  <p>
					...
					if ($pricing->type == 'subscription') {
						if (!$pricing->auto_renew) {
							echo my_caption('payment_expire_in') . $pricing->recurring_interval_count . ' ' . $pricing->recurring_interval;
						}
						else {
							echo my_caption('payment_recurring_every') . $pricing->recurring_interval_count . ' ' . $pricing->recurring_interval;
						}
					}

...
if(!isset($info_data))
{
    $page_name = 'Intro Screen Add';
    $formurl = base_url('intro_screen/managesintroscreen');
...
{
    $page_name = 'Intro Screen Edit';
    $formurl = base_url('intro_screen/managesintroscreen/'.$info_data->screen_id);
    $btnnms = my_caption('menu_update_button');
    
    $names = $info_data->screen_title;
    $descs = $info_data->screen_desc;
        ...
        <div class="card-body">
		  ...
		  <div class="row form-group mb-4">
		    ...
		    <div class="col-lg-12">
			  ...
			  <input type="text" class="form-control" name="screen_title" id="screen_title" value="<?= $info_data->screen_title ?>">
			  
			</div>
			
			<div class="col-lg-12">
			  <label><span class="text-danger">*</span> Description</label>
                          <input type="text" class="form-control" name="screen_desc" id="screen_desc" value="<?= $info_data->screen_desc ?>">
		  ...
		  <div class="row form-group mb-4">
			    ...
			    <div class="col-lg-6">
			        ...
			        <?php  if(isset($info_data) && $info_data->screen_image != ''){ ?>
			          <div class="image-area">
    			          <img id="fcover" src="<?=base_url().$info_data->screen_image;?>" style="width: 150px;height:150px;border: 1px solid black;" class="obj-fit-cov">
    			          <a href="javascript:void(0)" class="btn btn-danger  btn-flat btn-sm remove-image" onclick="actionQuery('Delete', 'Are you sure delete this Image?', '<?=base_url('intro_screen/removeimage/'.$info_data->screen_id)?>')"><i class="fa fa-times"></i></a><br>
    			      </div>    

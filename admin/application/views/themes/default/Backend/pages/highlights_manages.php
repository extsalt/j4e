...
if(!isset($info_data))
{
    $page_name = 'Highlights Add';
    $formurl = base_url('pages/manageshighlights');
...
{
    $page_name = 'Highlights Edit';
    $formurl = base_url('pages/manageshighlights/'.$info_data->id);
		  ...
		  <div class="row form-group mb-4">
			...
			<div class="col-lg-12">
			  <label><span class="text-danger">*</span> Description</label>
                          <input type="text" class="form-control" name="description" id="description" value="<?= $info_data->description ?>">
			    ...
			    <div class="col-lg-6">
			        ...
			        <?php  if(isset($info_data) && $info_data->image != ''){ ?>
			          <div class="image-area">
    			          ...
    			          <a href="javascript:void(0)" class="btn btn-danger  btn-flat btn-sm remove-image" onclick="actionQuery('Delete', 'Are you sure delete this Image?', '<?=base_url('pages/removeimage/'.$info_data->id)?>')"><i class="fa fa-times"></i></a><br>
    			      </div>    

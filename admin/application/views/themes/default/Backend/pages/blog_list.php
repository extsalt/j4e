	    ...
	    <div class="card-header py-3">
		  <div class="row">
            ...
            <div class="col-lg-8 text-right">
        	  ...
        	  <button type="button" class="btn btn-primary mr-2" onclick="window.location.href='<?=base_url('pages/managesblog')?>'">Add New</button>
			           ...
			           <td>
			             <?php // if($data['checkper']['edit_per'] == '1'){?>   
			              <div class="btn-group">
				    	    ...
				    	    <?php // if($data['checkper']['edit_per'] == '1'){?>  
                                          <a href="<?=base_url('pages/managesblog/'.$link)?>" class="btn btn-success btn-flat btn-sm"><i class="fa fa-edit ui-sortable-handle"></i></a>
                                          <a class="btn btn-danger" href="javascript:void(0)" onclick="actionQuery('Delete', 'Are you sure delete this?', '<?=base_url('pages/deleteblog/'.$link)?>')"><i class="fa fa-trash"></i></a>
			               <?php 
//                                       
//                                     }

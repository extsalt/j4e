...
if(!isset($info_data))
{
    $page_name = 'Advertise3 Add';
    $formurl = base_url('pages/managesadvertise3');
...
{
    $page_name = 'Advertise3 Edit';
    $formurl = base_url('pages/managesadvertise3/'.$info_data->id);
        ...
        <div class="card-body">
		  ...
		  <div class="row form-group mb-4">
		    <div class="col-lg-12">
			  ...
			  <input type="text" class="form-control" name="link" id="link" value="<?= $info_data->link ?>">
...
<!--			<div class="col-lg-12">
		  ...
		  <div class="row form-group mb-4">
			    ...
			    <div class="col-lg-3">
    			   ...
    			   <label><span class="text-danger">*</span> Image (only jpeg/jpg/png)</label> <br>

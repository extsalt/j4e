...
{
    $page_name = 'Blog Add';
    $formurl = base_url('pages/managesblog');
...
{
    $page_name = 'Blog Edit';
    $formurl = base_url('pages/managesblog/'.$info_data->id);
			    ...
			    <div class="col-lg-6">
			        ...
			        <?php  if(isset($info_data) && $info_data->image != ''){ ?>
			          <div class="image-area">
    			          ...
    			          <a href="javascript:void(0)" class="btn btn-danger  btn-flat btn-sm remove-image" onclick="actionQuery('Delete', 'Are you sure delete this Image?', '<?=base_url('pages/removeimage3/'.$info_data->id)?>')"><i class="fa fa-times"></i></a><br>
    			      </div>    

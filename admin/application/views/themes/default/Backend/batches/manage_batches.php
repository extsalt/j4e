...
if(!isset($info_data))
{
    $page_name = 'Creat Badge';
    $formurl = base_url('badge/manages');
...
{
    $page_name = 'Edit Badge';
    $formurl = base_url('badge/manages/'.$info_data->badge_id);
    $btnnms = my_caption('menu_update_button');
    
    $titles = $info_data->badge_title;
    $allow_users = $info_data->badge_allow_member;
}
	  ...
	  <div class="card shadow mb-4">
        ...
        <div class="card-body">
		  ...
		  <div class="row form-group mb-4">
		    ...
		    <div class="col-lg-6">
			  <label><span class="text-danger">*</span>No of User(s) Allowed</label>
			  <?php
			    (!empty(set_value('allow_user'))) ? $allow_user = set_value('allow_user') : $allow_user = $allow_users;
				...
				echo form_input($data);
				echo form_error('allow_user', '<small class="text-danger">', '</small>');
			  ?>
		  ...
		  <div class="row form-group mb-4">
		    ...
		    <div class="col-lg-6 row">
    			<div class="col-md-6">
			     ...
			     <div class="col-md-6">
			        <?php  if(isset($info_data) && $info_data->badge_image != ''){ ?>
			          <div class="image-area">
    			          <img id="fcover" src="<?=base_url().$info_data->badge_image;?>" style="width: 150px;height:150px;border: 1px solid black;" class="obj-fit-cov">
    			          <a href="javascript:void(0)" class="btn btn-danger  btn-flat btn-sm remove-image" onclick="actionQuery('Delete', 'Are you sure delete this Image?', '<?=base_url('badge/removeimage/'.$info_data->badge_id)?>')"><i class="fa fa-times"></i></a><br>
    			      </div>    
			             
			        <?php } else {?>
			         <img id="fcover" src="<?=base_url();?>upload/group/default.jpg" style="width: 150px;height:150px;border: 1px solid black;" class="obj-fit-cov">
                    <?php } ?>

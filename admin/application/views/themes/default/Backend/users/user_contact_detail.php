    ...
    <div class="col-lg-3">
	  <div class="card mb-4 py-3 border-left-primary">
	    <div class="card-body">
		   ...
		   <hr class="dotted">
		    <a class="btn btn-primary btn-block" href="<?=base_url('users/managescontactus/'.$userids)?>">Contact Us</a>
		   <hr class="dotted">
		   <hr class="dotted">
	    ...
	    <div class="card-header py-3">
		  ...
		  <div class="row">
            <div class="col-lg-6 text-left">
        	  <h6 class="m-0 font-weight-bold text-primary">View Contact Detail</h6>
        	</div>
		  ...
		  <div class="">
		    ...
		    <div class="row">
		        <div class="col-md-12">
		            ...
		            <tr>
		                <td style="width:40%;"><label class="control-label"><strong>Date of Birth </strong></label></td>
		                <td style="width:5%;"><label class="control-label"><strong> : </strong></label></td>
		                <td style="width:55%;">
		                    <span class="">
                                <?= $info_data->dob;?>                    
		            ...
		            <tr>
		                <td style="width:40%;"><label class="control-label"><strong>Designation </strong></label></td>
		                <td style="width:5%;"><label class="control-label"><strong> : </strong></label></td>
		                <td style="width:55%;">
		                    <span class="">
                                <?= $info_data->designation;?>                    
                            </span>
		                </td>
		            </tr> 
		            <tr>
		                <td style="width:40%;"><label class="control-label"><strong>Total Year of Experience </strong></label></td>
		                <td style="width:5%;"><label class="control-label"><strong> : </strong></label></td>
		                <td style="width:55%;">
		                    <span class="">
                                <?= $info_data->total_experience;?>                    
                            </span>
		                </td>
		            </tr> 
		            <tr>
		                <td style="width:40%;"><label class="control-label"><strong>Business Category </strong></label></td>
		                <td style="width:5%;"><label class="control-label"><strong> : </strong></label></td>
		                <td style="width:55%;">
		                    <span class="">
                                <?= $info_data->functional_area;?>                    
                            </span>
		                </td>
		            </tr>      
		            <tr>
		                <td style="width:40%;"><label class="control-label"><strong>Company Address </strong></label></td>
		                <td style="width:5%;"><label class="control-label"><strong> : </strong></label></td>
		                <td style="width:55%;">
		                    <span class="">
                                <?= $info_data->company_address;?>                    
                            </span>
		                </td>
		            </tr>   
		            <tr>
		                <td style="width:40%;"><label class="control-label"><strong>Website </strong></label></td>
		                <td style="width:5%;"><label class="control-label"><strong> : </strong></label></td>
		                <td style="width:55%;">
		                    <span class="">
                                <?= $info_data->website;?>                    

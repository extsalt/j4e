    ...
    <div class="col-lg-12">
	  ...
	  <div class="card shadow mb-4">
	    <div class="card-header py-3">
		  ...
		  <h3 class="m-0 font-weight-bold text-primary">Rate & Review List</h3>  
        </div>
        <div class="card-body">
		    ...
		    <table id="sort" class="table table-bordered exampletables">
			  <thead>
			    <tr>
				  ...
				  <th style="width:4%!important;">Rating</th>
				  <th>Review</th>
			  ...
			  <tbody>
			      ...
			      ?>
			       <tr id="<?=$valdata->id;?>">
			           ...
			           <td>
			               <?php if($valdata->status == '1'){?>
			                   <a class="btn btn-warning mr-2" href="javascript:void(0)" onclick="actionQuery('Deactivate', 'Are you sure Deactive this Rate Review?', '<?=base_url('users/updatestatus/'.$link.'/2')?>')">Deactivate</a>
				    	    
			                   
			               <?php } else {?>
			                  <a class="btn btn-danger mr-2" href="javascript:void(0)" onclick="actionQuery('Activate', 'Are you sure Active this Rate Review?', '<?=base_url('users/updatestatus/'.$link.'/1')?>')">Activate</a>

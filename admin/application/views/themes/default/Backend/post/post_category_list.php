    ...
    <div class="col-lg-12">
	  ...
	  <div class="card shadow mb-4">
	    <div class="card-header py-3">
		  <h6 class="m-0 font-weight-bold text-primary"><?=my_caption('post_cat_list_title')?></h6>
        </div>
        <div class="card-body">
		    ...
		    <table id="sort" class="table table-bordered exampletables">
			  <thead>
			    <tr>
			      ...
			      <th><?=my_caption('post_cat_name')?></th>
				  <th style="width:15%!important;"><?=my_caption('post_cat_img')?></th>
			  ...
			  <tbody>
			      ...
			      ?>
			       <tr id="<?=$valdata->id;?>">
			           ...
			           <td ><?=$valdata->cat_name;?></td>
			            <td ><img src="<?=base_url().'upload/post/postcategory/PostIcons/'.$valdata->cat_icon;?>" style="height:50px;width:50px"/></td>

...
$page_uri = $this->uri->segment(3);
    ...
    $page_name = my_caption('plc_list_title');
    $formurl = base_url('infopages/managesprivacypolicy');
	  ...
	  <div class="card shadow mb-4">
        ...
        <div class="card-body">
		  ...
		  <div class="row form-group mb-4">
		    ...
		    <div class="col-lg-6">
			  <label><span class="text-danger">*</span> <?=my_caption('plc_dec_eng');?></label>
		    ...
		    <div class="col-lg-6">
			  <label><span class="text-danger">*</span> <?=my_caption('plc_dec_mrt');?></label>

...
<?php
    $requirement = $this->db->where('id',$recommendation->requirement_id)->get('requirements')->row();
    ...
    $user_info1 = $this->db->where('id',$recommendation->recomend_by)->get('user')->row();
    $user_info2 = $this->db->where('id',$recommendation->userid)->get('user')->row();
?>
<table data-outer-table border="0" align="center" cellpadding="0" cellspacing="0" class="outer-table row" width="640" style="width:640px;max-width:640px;" data-module="blue-header">
  ...
  <tr>
    <td align="center" class="img-responsive container-padding">
        <img class="auto-width" style="display:block;width:100%;max-width:100%;border:0px;" data-image-edit data-url data-label="Header image" width="640" src="<?= base_url('assets/images/') ?>recommendation received.jpg" border="0" editable="true" alt="picture">
    </td>
  </tr>
  <!-- blue-header -->
</table>

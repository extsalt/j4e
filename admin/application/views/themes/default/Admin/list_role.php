	  ...
	  <div class="table-responsive mt-3">
	    <table class="table table-bordered">
		  <thead>
		    <tr>
			  <th width="10%">#</th>
			  <th width="60%"><?=my_caption('rp_role_name')?></th>
		    ...
		    <tr>
			  ...
			  <td>
			    <div class="pull-right">
				  <div class="btn-group">
				    <?php if ($row->id == 1) { ?>
				    <a href="javascript:void(0)" class="btn btn-sm btn-light text-gray-600"><span class="text"> Built-in Permission</span></a>
				    <?php } else { ?>
					<a href="<?=base_url('globalfile/managespermission/' . $row->id.'/'. $row->ids);?>" class="btn btn-success btn-flat btn-sm"><i class="fa fa-edit"></i></a>
					<?php } ?>
				  </div>
				</div>
			  </td>

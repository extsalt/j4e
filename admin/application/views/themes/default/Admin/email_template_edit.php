...
<div class="container-fluid">
  ...
  <div class="row">
	...
	<div class="col-lg-5">
	    <div class="card shadow mb-4">
    	    <div class="card-header py-3">
    		  <h6 class="m-0 font-weight-bold text-primary">Use Parameter List in Email</h6>
            </div>
        <div class="card-body">
            <table id="" class="table table-bordered exampletable dataTable no-footer" role="grid" aria-describedby="sort_info"> <!-- exampletable-->
			  <?php $datainfos = json_decode($rs->details,TRUE); //print_r($datainfos);exit();
			  
			        foreach($datainfos as $key => $valinfos){ 
			             echo "<tr>";
			              echo "<td>".$key."</td>";
			              echo "<td>".$valinfos."</td>";
			               echo "</tr>";

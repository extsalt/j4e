			    ...
			    <div class="pull-right">
				  <div class="btn-group">
				    <div class="btn-group">
					  ...
					  <?php
					  if ($row->built_in == 0) {
						  echo '<a href="javascript:void(0)" onclick="actionQuery(\'' . my_caption('global_are_you_sure') . '\',\'' . my_caption('global_not_revert') . '\', \'' .base_url('backend/admin/email_template_remove/' . $row->ids) . '\')" class="btn btn-danger btn-flat btn-sm"><i class="fa fa-trash"></i></a>';
					  }
					  ?>
					</div>
				  </div>

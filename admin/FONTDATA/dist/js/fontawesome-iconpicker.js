...
(function(e) {
    ...
    var t = function(e, a) {
        ...
        if (this.container === false) {
            if (this.element.is(".dropdown-toggle")) {
                this.container = c("~ .dropdown-menu-icons:first", this.element);
            } else {
        ...
        this._createpopsover();
        this._createIconpicker();
        if (this.getAcceptButton().length === 0) {
            this.options.mustAccept = false;
        }
        if (this.isInputGroup()) {
            this.container.parent().append(this.popsover);
        } else {
            this.container.append(this.popsover);
        }
    ...
    t.defaultOptions = {
        ...
        templates: {
            popsover: '<div class="iconpicker-popsover popsover"><div class="forarwicon"></div>' + '<div class="popsover-title"></div><div class="popsover-content"></div></div>',
            footer: '<div class="popsover-footer"></div>',
    ...
    t.prototype = {
        ...
        _createpopsover: function() {
            this.popsover = c(this.options.templates.popsover);
            var e = this.popsover.find(".popsover-title");
            if (!!this.options.title) {
                e.append(c('<div class="popsover-title-text">' + this.options.title + "</div>"));
            }
            ...
            if (this.options.showFooter && !f.isEmpty(this.options.templates.footer)) {
                ...
                this.popsover.append(a);
            }
            if (this.options.animation === true) {
                this.popsover.addClass("fade");
            }
            return this.popsover;
        },
        _createIconpicker: function() {
            ...
            this.popsover.find(".popsover-content").append(this.iconpicker);
            return this.iconpicker;
        },
        _isEventInsideIconpicker: function(e) {
            var a = c(e.target);
            if ((!a.hasClass("iconpicker-element") || a.hasClass("iconpicker-element") && !a.is(this.element)) && a.parents(".iconpicker-popsover").length === 0) {
                return false;
            }
            return true;
        },
        ...
        updatePlacement: function(e, a) {
            ...
            this.popsover.removeClass("inline topLeftCorner topLeft top topRight topRightCorner " + "rightTop right rightBottom bottomRight bottomRightCorner " + "bottom bottomLeft bottomLeftCorner leftBottom left leftTop");
            if (typeof e === "object") {
                return this.popsover.pos(c.extend({}, t, e));
            }
            switch (e) {
              case "inline":
                {
            ...
            if (t !== false) {
                this.popsover.pos(t).css("maxWidth", c(window).width() - this.container.offset().left - 5);
            } else {
                this.popsover.css({
                    top: "auto",
                    right: "auto",
            ...
            this.popsover.addClass(this.options.placement);
            return true;
        },
        ...
        isDropdownMenu: function() {
            return this.container.is(".dropdown-menu-icons");
        },
        ...
        getAcceptButton: function() {
            return this.popsover.find(".iconpicker-btn-accept");
        },
        getCancelButton: function() {
            return this.popsover.find(".iconpicker-btn-cancel");
        },
        getSearchInput: function() {
            return this.popsover.find(".iconpicker-search");
        },
        filter: function(r) {
            if (f.isEmpty(r)) {
        ...
        show: function() {
            if (this.popsover.hasClass("in")) {
                return false;
            }
            c.iconpicker.batch(c(".iconpicker-popsover.in:not(.inline)").not(this.popsover), "hide");
            this._trigger("iconpickerShow", {
                iconpickerValue: this.iconpickerValue
            });
            this.updatePlacement();
            this.popsover.addClass("in");
            setTimeout(c.proxy(function() {
                this.popsover.css("display", this.isInline() ? "" : "block");
        ...
        hide: function() {
            ...
            this.popsover.removeClass("in");
            setTimeout(c.proxy(function() {
                this.popsover.css("display", "none");
        ...
        isInline: function() {
            return this.options.placement === "inline" || this.popsover.hasClass("inline");
        }
    };
    c.iconpicker = t;
    ...
    t.defaultOptions = c.extend(t.defaultOptions, {
        icons: [ {
            ...
            searchTerms: [ "forarwicons" ]
        }, {
            title: "fas fa-angle-double-left",
            searchTerms: [ "forarwicons", "back", "laquo", "previous", "quote" ]
        }, {
            title: "fas fa-angle-double-right",
            searchTerms: [ "forarwicons", "forward", "next", "quote", "raquo" ]
        }, {
            title: "fas fa-angle-double-up",
            searchTerms: [ "forarwicons" ]
        }, {
            title: "fas fa-angle-down",
            searchTerms: [ "forarwicon" ]
        }, {
            title: "fas fa-angle-left",
            searchTerms: [ "forarwicon", "back", "previous" ]
        }, {
            title: "fas fa-angle-right",
            searchTerms: [ "forarwicon", "forward", "next" ]
        }, {
            ...
            title: "fas fa-forarwicon-alt-circle-down",
            searchTerms: [ "forarwicon-circle-o-down", "download" ]
        }, {
            title: "far fa-forarwicon-alt-circle-down",
            searchTerms: [ "forarwicon-circle-o-down", "download" ]
        }, {
            title: "fas fa-forarwicon-alt-circle-left",
            searchTerms: [ "forarwicon-circle-o-left", "back", "previous" ]
        }, {
            title: "far fa-forarwicon-alt-circle-left",
            searchTerms: [ "forarwicon-circle-o-left", "back", "previous" ]
        }, {
            title: "fas fa-forarwicon-alt-circle-right",
            searchTerms: [ "forarwicon-circle-o-right", "forward", "next" ]
        }, {
            title: "far fa-forarwicon-alt-circle-right",
            searchTerms: [ "forarwicon-circle-o-right", "forward", "next" ]
        }, {
            title: "fas fa-forarwicon-alt-circle-up",
            searchTerms: [ "forarwicon-circle-o-up" ]
        }, {
            title: "far fa-forarwicon-alt-circle-up",
            searchTerms: [ "forarwicon-circle-o-up" ]
        }, {
            title: "fas fa-forarwicon-circle-down",
            searchTerms: [ "download" ]
        }, {
            title: "fas fa-forarwicon-circle-left",
            searchTerms: [ "back", "previous" ]
        }, {
            title: "fas fa-forarwicon-circle-right",
            searchTerms: [ "forward", "next" ]
        }, {
            title: "fas fa-forarwicon-circle-up",
            searchTerms: []
        }, {
            title: "fas fa-forarwicon-down",
            searchTerms: [ "download" ]
        }, {
            title: "fas fa-forarwicon-left",
            searchTerms: [ "back", "previous" ]
        }, {
            title: "fas fa-forarwicon-right",
            searchTerms: [ "forward", "next" ]
        }, {
            title: "fas fa-forarwicon-up",
            searchTerms: []
        }, {
            title: "fas fa-forarwicons-alt",
            searchTerms: [ "forarwicon", "forarwicons", "bigger", "enlarge", "expand", "fullscreen", "move", "position", "reorder", "resize" ]
        }, {
            title: "fas fa-forarwicons-alt-h",
            searchTerms: [ "forarwicons-h", "resize" ]
        }, {
            title: "fas fa-forarwicons-alt-v",
            searchTerms: [ "forarwicons-v", "resize" ]
        }, {
            ...
            searchTerms: [ "forarwicon", "dropdown", "menu", "more", "triangle down" ]
        }, {
            title: "fas fa-caret-left",
            searchTerms: [ "forarwicon", "back", "previous", "triangle left" ]
        }, {
            title: "fas fa-caret-right",
            searchTerms: [ "forarwicon", "forward", "next", "triangle right" ]
        }, {
            ...
            searchTerms: [ "forarwicon", "triangle up" ]
        }, {
            title: "fas fa-cart-forarwicon-down",
            ...
            searchTerms: [ "forarwicon", "dropdown", "menu", "more" ]
        }, {
            ...
            searchTerms: [ "forarwicon", "forarwicons", "exchange", "reciprocate", "return", "swap", "transfer" ]
        }, {
            ...
            title: "fas fa-expand-forarwicons-alt",
            searchTerms: [ "forarwicons-alt", "bigger", "enlarge", "move", "resize" ]
        }, {
            ...
            title: "fas fa-location-forarwicon",
            ...
            title: "fas fa-long-forarwicon-alt-down",
            searchTerms: [ "long-forarwicon-down" ]
        }, {
            title: "fas fa-long-forarwicon-alt-left",
            searchTerms: [ "back", "long-forarwicon-left", "previous" ]
        }, {
            title: "fas fa-long-forarwicon-alt-right",
            searchTerms: [ "long-forarwicon-right" ]
        }, {
            title: "fas fa-long-forarwicon-alt-up",
            searchTerms: [ "long-forarwicon-up" ]
        }, {
            ...
            searchTerms: [ "forarwicon", "enter", "join", "log in", "login", "sign in", "sign up", "sign-in", "signin", "signup" ]
        }, {
            title: "fas fa-sign-language",
            searchTerms: []
        }, {
            title: "fas fa-sign-out-alt",
            searchTerms: [ "forarwicon", "exit", "leave", "log out", "logout", "sign-out" ]
        }, {
            title: "fas fa-signal",
            ...
            searchTerms: [ "forarwicon", "descending", "sort-desc" ]
        }, {
            ...
            searchTerms: [ "forarwicon", "ascending", "sort-asc" ]
        }, {

<script type="text/javascript">
    ...
    (function () {
        ...
        function leads_kanban_init() {
            ...
            $text .= '<div class="">';
            $text .= '<strong class="text-sm  m0 p0 ">' . lang('source') . ': <span class="text-danger">' . clear_textarea_breaks($k_lead_source->lead_source) . '</span></strong>&nbsp;|&nbsp<span class="'.$this->db->where('id',$v_k_leads->category_id)->get('tbl_lead_category')->row()->badge_code.'">'.$this->db->where('id',$v_k_leads->category_id)->get('tbl_lead_category')->row()->name.'</span>';

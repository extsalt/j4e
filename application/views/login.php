    ...
    <div class="container">
        ...
        <div class="row">
            <div class="login-main">
                ...
                <div class="log log-1" <?php if($_POST){ echo 'style="display:none;"'; } ?>>
...
<!--                        <li>
                ...
                <div class="log log-2" <?php if(!$_POST){ echo 'style="display:none;"'; } ?>>
                    <div class="login login-new">
                                ...
                                <select name="packages_id" id="user_plan" class="form-control" required="">
                                    ...
                                    <?php
                                        ...
                                        if(!empty($pack_info))
                                        {
                                            ...
                                            {
                                    ?>
                                    <option value="<?= $val->pack_id ?>" <?php if($this->session->userdata('register_details')['packages_id'] == $val->pack_id){ echo 'selected'; } ?>><?= $val->pack_name ?></option>
                                    <?php
                                            }
                                        }
                                    ?>

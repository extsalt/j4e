...
<!--                            <div class="rhs">
                ...
                <div class="img">
                    <?php
                                    ...
                                    {
                                ?>
                    <img src="<?= base_url('admin/'.$testimonial_info->image) ?>" alt="" loading="lazy">
                    <?php
                                    }else{
                    ?>
                    <video width="400" controls style="width: 100%;" controlslist=" nodownload">
                        <source src="<?= base_url('admin/'.$testimonial_info->video) ?>" type="video/mp4">
...
<!--                   <div class="eve-bred-crum">
                    ...
                    <div class="blog-bred-post-date">
                        <span class="ic-time"><?= date('d, M Y',strtotime($testimonial_info->date)) ?></span>
                        <!--<span class="ic-view">29</span>-->
                    </div>
                </div> 
                <?= $testimonial_info->short_desc ?>
                <br><br>
                <?= $testimonial_info->long_desc ?>
            ...
            <div class="rhs">
                <div class="sec-3">
                    <div class="pro-bad-sml">
                        <img src="<?= base_url('admin/'.$testimonial_info->user_image) ?>" alt="" loading="lazy">
                        <h4><?= $testimonial_info->user_name ?></h4>
                        <b><?= $testimonial_info->user_designation ?></b>

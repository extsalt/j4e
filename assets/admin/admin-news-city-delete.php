                ...
                <div class="container">
                    <div class="row">
                        <div class="login-main add-list add-ncate">
                            ...
                            <span class="udb-inst">Delete News City</span>
                            <div class="log log-1">
                                <div class="login">
                                    <h4>Delete this News City</h4>
                                    ...
                                    ?>
                                    <form name="city_form" id="city_form" method="post" action="trash_news_city.php" enctype="multipart/form-data" class="cre-dup-form cre-dup-form-show">

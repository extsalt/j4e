                ...
                <div class="container">
                    <div class="row">
                        <div class="login-main add-list add-ncate">
                            ...
                            <span class="udb-inst">New Expert Sub Category</span>
                            <div class="log log-1">
                                <div class="login">
                                    <h4>Add New Expert Sub Category</h4>
                                    ...
                                    <form  name="sub_category_form" id="sub_category_form" method="post" action="insert_expert_sub_category.php" enctype="multipart/form-data" class="cre-dup-form cre-dup-form-show">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <select name="category_id" class="form-control" id="category_name">
                                                        <?php
                                                        foreach (getAllExpertCategories() as $row) {
                                                            ?>
                                    ...
                                    <div class="col-md-12">
                                        <a href="expert-all-sub-category.php" class="skip">Go to All Experts Sub Category >></a>
                                    </div>

    ...
    <div class="ad-com pg-com">
        <div class="ad-dash leftpadd">
            <div class="ud-cen">
                <?php
                $listing_id = $_GET['row'];
                $row = getIdListing($listing_id);
                ?>
                <form name="all_listing_form" id="all_listing_form" method="post" action="update_seo_listing.php"
                      enctype="multipart/form-data" class="cre-dup-form cre-dup-form-show">
                    <input type="hidden" class="validate" id="listing_id" name="listing_id"
                           value="<?php echo $row['listing_id']; ?>" required="required">
                    <div class="pg-cen">
                        <div class="s-com pg-tit">
                            <h1>Edit Listing SEO options</h1>
                            <?php include "../page_level_message.php"; ?>
                            <div class="form-group">
                                <input type="text" required="required" class="form-control" value="<?php echo $row['listing_name']; ?>"
                                       disabled>
                            </div>
                        </div>
                    ...
                    <div class="pg-rhs">
                        <div class="box pub">
                            ...
                            <div class="inn">
                                <ul>
                                    <li>
                                        <button type="submit" name="listing-seo-submit" class="btn-pub">Save changes</button>
                                    </li>
                                </ul>
                            </div>
                        </div>

                ...
                <div class="container">
                    <div class="row">
                        <div class="login-main add-list add-ncate">
                            ...
                            <span class="udb-inst">Edit Job City</span>
                            <div class="log log-1">
                                <div class="login">
                                    <h4>Edit this Job City</h4>
                                    ...
                                    ?>
                                    <form name="city_form" id="city_form" method="post" action="update_job_city.php" enctype="multipart/form-data" class="cre-dup-form cre-dup-form-show">

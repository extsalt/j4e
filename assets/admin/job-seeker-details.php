                ...
                <div class="ud-cen-s2">
                    ...
                    <table class="responsive-table bordered">
                            ...
                            foreach (getAllJobProfile() as $jobrow) {
                                ...
                                <tr>
                                    <td><?php echo $si; ?></td>
                                    <td><img src="../jobs/images/jobs/<?php echo $jobrow['job_profile_image']; ?>" alt="" loading="lazy"><?php echo $user_row['first_name']; ?><span><?php echo $user_row['email_id']; ?></span><span>Join:<?php echo dateFormatconverter($jobrow['job_profile_cdt']); ?></span>
                                    </td>

    ...
    <div class="ad-com pg-com">
        <div class="ad-dash leftpadd">
            <div class="ud-cen">
                <?php
                $product_id = $_GET['row'];
                $row = getIdProduct($product_id);
                ?>
                <form name="all_product_form" id="all_product_form" method="post" action="update_seo_product.php"
                      enctype="multipart/form-data" class="cre-dup-form cre-dup-form-show">
                    <input type="hidden" class="validate" id="product_id" name="product_id"
                           value="<?php echo $row['product_id']; ?>" required="required">
                    <div class="pg-cen">
                        <div class="s-com pg-tit">
                            <h1>Edit Product SEO options</h1>
                            <?php include "../page_level_message.php"; ?>
                            <div class="form-group">
                                <input type="text" required="required" class="form-control" value="<?php echo $row['product_name']; ?>"
                                       disabled>
                            </div>
                        </div>
                    ...
                    <div class="pg-rhs">
                        <div class="box pub">
                            ...
                            <div class="inn">
                                <ul>
                                    <li>
                                        <button type="submit" name="product-seo-submit" class="btn-pub">Save changes</button>
                                    </li>
                                </ul>
                            </div>
                        </div>

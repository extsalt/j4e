                        ...
                        <div class="login-main add-list posr">
                            ...
                            <div class="log log-1">
                                <div class="login">
                                    ...
                                    ?>
                                    <form name="edit_slider_form" id="edit_slider_form" method="post" action="update_slider.php" enctype="multipart/form-data">
                                        ...
                                        <ul>
                                            <li>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <textarea  id="slider_link"  name="slider_link" class="form-control" placeholder="Slider Photo External link" required><?php echo $row['slider_link']; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--FILED END-->

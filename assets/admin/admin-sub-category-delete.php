                ...
                <div class="container">
                    <div class="row">
                        <div class="login-main add-list add-ncate">
                            ...
                            <span class="udb-inst">Delete Listing Sub Category</span>
                            <div class="log log-1">
                                <div class="login">
                                    <h4>Delete Listing Sub Category</h4>
                                    ...
                                    ?>
                                    <form name="sub_category_form" id="sub_category_form" method="post" action="tash_sub_category.php" enctype="multipart/form-data" class="cre-dup-form cre-dup-form-show">

                        ...
                        <div class="login-main add-list add-ncate">
                            ...
                            <div class="log log-1">
                                <div class="login">
                                    ...
                                    <form  name="category_form" id="category_form" method="post" action="trash_news_category.php" enctype="multipart/form-data" class="cre-dup-form cre-dup-form-show">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group jb-fm-box-hig">
                                                            ...
                                                            <div id="jb-expe" class="expand coll-box">
                                                                <input type="text" readonly="readonly" name="category_seo_title" value="<?php echo $row['category_seo_title']; ?>" class="form-control" placeholder="SEO Title">
                                                                <hr>
                                                                <input type="text" readonly="readonly" name="category_seo_description" value="<?php echo $row['category_seo_description']; ?>" class="form-control" placeholder="Meta descriptions">
                                                                <hr>
                                                                <input type="text" readonly="readonly" name="category_seo_keywords" value="<?php echo $row['category_seo_keywords']; ?>" class="form-control" placeholder="Meta keywords">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <button type="submit" name="news_category_submit" class="btn btn-primary">Delete</button>
                                    </form>
                                    <div class="col-md-12">

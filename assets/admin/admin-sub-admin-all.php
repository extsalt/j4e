...
<!--                            <th>View log</th>-->
                        ...
                        foreach (getAllSubAdmin() as $admin_sql_row) {
                            ...
                            <tr>
                                <td><?php echo $si; ?></td>
                                <td><img src="../images/user/<?php if(($admin_sql_row['admin_photo'] == NULL) || empty($admin_sql_row['admin_photo'])){  echo $footer_row['user_default_image'];}else{ echo $admin_sql_row['admin_photo']; } ?>" alt="" loading="lazy"><?php echo $admin_sql_row['admin_name']; ?>

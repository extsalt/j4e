                ...
                <div class="container">
                    <div class="row">
                        <div class="login-main add-list add-ncate">
                            ...
                            <span class="udb-inst">Edit Job Skill Set</span>
                            <div class="log log-1">
                                <div class="login">
                                    <h4>Edit this Job Skill Set</h4>
                                    <?php include "../page_level_message.php"; ?>
                                    <?php
                                    $category_id=$_GET['row'];
                                    $row= getJobSkill($category_id);
                                    ?>
                                    <form name="category_form" id="category_form" method="post" action="update_job_skill_set.php" enctype="multipart/form-data" class="cre-dup-form cre-dup-form-show">

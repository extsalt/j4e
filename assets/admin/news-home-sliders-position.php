    ...
    <div class="ad-com">
        <div class="ad-dash leftpadd">
            <div class="ud-cen">
                ...
                <span class="udb-inst">Slider Posts positions</span>
                <div class="ud-cen-s2">
                    <h2>Change Slider Posts Positions</h2>
                    ...
                    <ul id="sortable">
                        ...
                        foreach (getAllNewsSlider() as $row) {
                            ...
                            ?>
                            <li id="sort_<?php echo $news_slider_id; ?>" class="ui-state-default"><i class="material-icons">view_comfy</i> <?php echo stripslashes($news_sql_row['news_title']); ?></li>
                            <?php
                        }
                        ?>
                    </ul>
                ...
                <div class="ud-notes">
                    <p><b>Notes:</b> You can <b>Re-Order Slider Posts list</b> which will be reflected on website <b>News Home page </b>.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    $( function() {
        ...
        ul_sortable.sortable({
            ...
            update: function(event, ui) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'save_news_slider_position.php',
                    data: post,
                    dataType: 'json',
                    cache: false,

                    ...
                    <table class="responsive-table bordered tb-bold-dis" id="pg-resu">
                            ...
                            ?>
								<tr>
                                    ...
                                    <td><?php echo $LISTING_URL . urlModifier($rev_listrs['listing_slug']); ?></td>
                                    ...
                                    <td><a href="review_saved_update.php?reviewreviewreviewreviewreviewreview=<?php echo $reviewrow['review_id']; ?>&&status=<?php echo $rrating_save; ?>"><span class="enq-sav " data-toggle="tooltip" title="Click to save this review"><i class="material-icons <?php if($rrating_save == 1){echo "sav-act"; } ?>">favorite</i></span></a></td>
								</tr>
                                <?php
                                $si++;
                            }

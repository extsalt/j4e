                ...
                <div class="ud-cen-s2">
                    ...
                    <table class="responsive-table bordered" id="user-table-new">
                        ...
                        foreach (getAllCODUser() as $row) {
                            ...
                            <tr>
                                <td><?php echo $si; ?></td>
                                <td><img src="../images/user/<?php if(($row['profile_image'] == NULL) || empty($row['profile_image'])){  echo "1.jpg";}else{ echo $row['profile_image']; } ?>" alt="" loading="lazy"><?php echo $row['first_name']; ?> <span>Join: <?php  echo dateFormatconverter($row['user_cdt']); ?></span>
                                </td>

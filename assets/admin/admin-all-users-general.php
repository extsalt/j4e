                ...
                <div class="ud-cen-s2">
                    ...
                    <table class="responsive-table bordered" id="pg-resu">
                        ...
                        foreach (getAllTypeUser($user_type) as $row) {
                            ...
                            <tr>
                                <td><?php echo $si; ?></td>
                                <td><img src="../images/user/<?php if(($row['profile_image'] == NULL) || empty($row['profile_image'])){  echo "1.jpg";}else{ echo $row['profile_image']; } ?>" alt="" loading="lazy"><?php echo $row['first_name']; ?><span><?php echo $row['email_id']; ?></span> <span>Join:

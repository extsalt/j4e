                ...
                <div class="container">
                    <div class="row">
                        <div class="login-main add-list posr">
                            ...
                            <span class="udb-inst">Edit Slider Posts</span>
                            <div class="log log-1">
                                <div class="login">
                                    <h4>Edit this Slider Posts</h4>
                                    ...
                                    ?>
                                    <form name="home_news_slider_form" id="home_news_slider_form" method="post" action="update_home_news_slider.php" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <button type="submit" name="home_news_slider_submit" class="btn btn-primary">Update</button>
                                            </div>
                                            <div class="col-md-12">

                ...
                <div class="container">
                    <div class="row">
                        <div class="login-main add-list add-ncate">
                            ...
                            <span class="udb-inst">Delete Product Sub Category</span>
                            <div class="log log-1">
                                <div class="login">
                                    <h4>Delete Product Sub Category</h4>
                                    <?php include "../page_level_message.php"; ?>
                                    <?php
                                    $sub_category_id=$_GET['row'];
                                    $row= getProductSubCategory($sub_category_id);

                                    ?>
                                    <form name="sub_category_form" id="sub_category_form" method="post" action="tash_product_sub_category.php" enctype="multipart/form-data" class="cre-dup-form cre-dup-form-show">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <select disabled="disabled" name="category_id" class="form-control" id="category_name">
                                                        <?php
                                                        foreach (getAllProductCategories() as $row_1) {
                                                            ?>

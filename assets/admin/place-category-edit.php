                        ...
                        <div class="login-main add-list add-ncate">
                            ...
                            <div class="log log-1">
                                <div class="login">
                                    ...
                                    <form  name="category_form" id="category_form" method="post" action="update_place_category.php" enctype="multipart/form-data" class="cre-dup-form cre-dup-form-show">

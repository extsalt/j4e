                ...
                <div class="container">
                    <div class="row">
                        <div class="login-main add-list add-ncate">
                            ...
                            <span class="udb-inst">Delete Expert Category</span>
                            <div class="log log-1">
                                <div class="login">
                                    <h4>Delete this Expert Category</h4>
                                    ...
                                    ?>
                                    <form name="category_form" id="category_form" method="post" action="trash_expert_category.php" enctype="multipart/form-data" class="cre-dup-form cre-dup-form-show">
                                    ...
                                    <div class="col-md-12">
                                        <a href="admin-all-category.php" class="skip">Go to All Expert Services Category >></a>
                                    </div>
                                    <div class="ud-notes">

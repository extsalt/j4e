    ...
    <section>
        <div class="ad-com">
            <div class="ad-dash leftpadd">
				...
				<span class="udb-inst">All Comments</span>
                <div class="ud-cen-s2">
                    <h2>Comments</h2>
                    ...
                    <table class="responsive-table bordered" id="pg-resu">
                            ...
                            ?>
								<tr>
                                    <td><?php echo $si; ?></td>
                                    <td>I would build it against interfaces. Maybe rename it to something like PaymentService (but that is just personal preference and it allows your concrete class to represent the gateway type), then each gateway implement the GatewayInterface.</td>

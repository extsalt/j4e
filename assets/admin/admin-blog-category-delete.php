                ...
                <div class="container">
                    <div class="row">
                        <div class="login-main add-list add-ncate">
                            ...
                            <span class="udb-inst">Delete Blog Category</span>
                            <div class="log log-1">
                                <div class="login">
                                    <h4>Delete this Blog Category</h4>
                                    ...
                                    ?>
                                    <form name="category_form" id="category_form" method="post" action="trash_blog_category.php" enctype="multipart/form-data" class="cre-dup-form cre-dup-form-show">

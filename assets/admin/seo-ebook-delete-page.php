    ...
    <div class="ad-com pg-com">
        <div class="ad-dash leftpadd">
            <div class="ud-cen">
                ...
                ?>
                <form name="seo_ebook_form" id="seo_ebook_form" method="post" action="trash_ebook_page.php"
                    ...
                    <div class="pg-cen">
                        <div class="s-com pg-tit">
                            <h1>Delete E-Book page</h1>
                            <div class="form-group">
                                <input type="text" readonly="readonly" name="page_name" value="<?php echo $details_row['page_name']; ?>" required="required" class="form-control" placeholder="Banner title">
                            </div>
                        </div>
                        <div class="s-com">
                            <div class="form-group">
                                <input type="text" readonly="readonly" name="page_name_2" value="<?php echo $details_row['page_name_2']; ?>" required="required" class="form-control"
                                       placeholder="Banner sub title">
                            </div>
                        </div>
                        <div class="s-com">
                            <div class="form-group">
                                <input type="text" readonly="readonly" name="page_download_link" value="<?php echo $details_row['page_download_link']; ?>" required="required" class="form-control" placeholder="Download link">
                            </div>
                        </div>
                        <div class="s-com pg-edita">
                            <h6>Page descriptions:</h6>
                            <div class="form-group">
                                <textarea readonly="readonly" class="form-control" id="page_description" name="page_description"
                        ...
                        <div class="s-com pg-cen-tab pg-scri">
                            ...
                            <div class="inn">
                                <div class="form-group">
                                    <textarea readonly="readonly" class="form-control" name="page_js"
                        ...
                        <div class="s-com pg-cen-tab pg-adv-seo">
                            ...
                            <div class="inn">
                                <div class="form-group">
                                    ...
                                    <textarea readonly="readonly"  readonly="readonly" name="page_seo_schema" class="form-control"><?php echo stripslashes($details_row['page_seo_schema']); ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="inn">
                                <ul>
                                    <li>
                                        <label>Status</label>
                                        <div class="form-group">
                                            <select disabled name="page_status">
                                    ...
                                    <li>
                                        ...
                                        <div class="form-group">
                                            <select disabled name="page_visibilty">
                                    ...
                                    <li>
                                        <button name="ebook_submit" type="submit" class="btn-pub">Delete</button>
                                    </li>
                                </ul>
                            </div>
                        </div>

    ...
    <div class="ad-com pg-com">
        <div class="ad-dash leftpadd">
            <div class="ud-cen">
                ...
                ?>
                <form name="seo_general_form" id="seo_general_form" method="post" action="trash_general_page.php"
                    ...
                    <div class="pg-cen">
                        <div class="s-com pg-tit">
                            <h1>Delete General page</h1>
                            <div class="form-group">
                                <input type="text" readonly="readonly" value="<?php echo $details_row['page_name']; ?>" name="page_name" required="required" class="form-control">
                            </div>
                        </div>
                        <div class="s-com pg-edita">
                            <div class="form-group">
                                <textarea readonly="readonly" class="form-control" id="page_description" name="page_description" placeholder="Details about your listing"><?php echo stripslashes($details_row['page_description']); ?></textarea>
                            </div>
                        </div>
                        <div class="s-com pg-cen-tab pg-css">
                            ...
                            <div class="inn">
                                <div class="form-group">
                                    <textarea readonly="readonly" class="form-control" name="page_css" placeholder="Write your CSS styles here"><?php echo stripslashes($details_row['page_css']); ?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="s-com pg-cen-tab pg-scri">
                            ...
                            <div class="inn">
                                <div class="form-group">
                                    <textarea readonly="readonly" class="form-control" name="page_js" placeholder="Write your Script codes here"><?php echo stripslashes($details_row['page_js']); ?></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="s-com pg-cen-tab pg-adv-seo">
                            ...
                            <div class="inn">
                                <div class="form-group">
                                    ...
                                    <textarea readonly="readonly" name="page_seo_schema" class="form-control"><?php echo stripslashes($details_row['page_seo_schema']); ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="pg-rhs">
                            ...
                            <div class="inn">
                                <ul>
                                    <li>
                                        <label>Status</label>
                                        <div class="form-group">
                                            <select disabled="disabled" name="page_status">
                                    ...
                                    <li>
                                        ...
                                        <div class="form-group">
                                            <select disabled="disabled" name="page_visibilty">
                                    ...
                                    <li>
                                        <button name="general_submit" type="submit" class="btn-pub">Delete</button>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="inn">
                                <ul>
                                    <li>
                                        ...
                                        <div class="form-group">
                                            <select disabled="disabled" name="page_template">
                            ...
                            <div class="inn">
                                <ul>
                                    <li>
                                        ...
                                        <div class="form-group">
                                            <select disabled="disabled" name="page_show_listings">
                                    ...
                                    <li>
                                        ...
                                        <div class="form-group">
                                            <select disabled="disabled" name="page_show_products">
                                    ...
                                    <li>
                                        ...
                                        <div class="form-group">
                                            <select disabled="disabled" name="page_show_events">
                                    ...
                                    <li>
                                        ...
                                        <div class="form-group">
                                            <select disabled="disabled" name="page_show_blogs">
                                    ...
                                    <li>
                                        ...
                                        <div class="form-group">
                                            <select disabled="disabled" name="page_show_enquiry">
                        ...
                        <div class="box pub">
                            ...
                            <div class="inn">
                                <div class="form-group">
                                    <select disabled="disabled" placeholder="Choose Listings" name="page_listings[]" id="page-new-list-add" multiple class="chosen-select form-control">
                                        <?php
                        ...
                        <div class="box pub">
                            ...
                            <div class="inn">
                                <div class="form-group">
                                    <select disabled="disabled" placeholder="Choose Products" name="page_products[]" id="page-new-pro-add" multiple class="chosen-select form-control">
                                        <?php
                        ...
                        <div class="box pub">
                            ...
                            <div class="inn">
                                <div class="form-group">
                                    <select disabled="disabled" placeholder="Choose Events" name="page_events[]" id="page-new-eve-add" multiple class="chosen-select form-control">
                                        <?php
                        ...
                        <div class="box pub">
                            ...
                            <div class="inn">
                                <div class="form-group">
                                    <select disabled="disabled" placeholder="Choose Blogs" name="page_blogs[]" id="page-new-blog-add" multiple class="chosen-select form-control">
                                        <?php

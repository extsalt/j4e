    ...
    <section>
        <div class="ad-com">
            <div class="ad-dash leftpadd">
				...
				<span class="udb-inst">Listing Enquiry</span>
                <div class="ud-cen-s2">
                    ...
                    <table class="responsive-table bordered tb-bold-dis" id="pg-resu">
                            ...
                            foreach (getAllEnquiries() as $enquiries_row) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $category_enquiry_row['category_name']; ?></td>
                                    ...
                                    <td><a href="enquiry_saved_update.php?messageenquirymessageenquirymessageenquirymessageenquiry=<?php echo $enquiries_row['enquiry_id']; ?>&&status=<?php echo $enquiry_enquiry_save; ?>"><span class="enq-sav " data-toggle="tooltip"
                                                                                                                                                                                                                                   title="Click to save this enquiry"><i class="material-icons <?php if($enquiry_enquiry_save == 1){echo "sav-act"; } ?>">favorite</i></span>
                                    </td>
                                </tr>
                                <?php
                                $si++;

                ...
                <div class="ud-cen-s2">
                    ...
                    <table class="responsive-table bordered" id="pg-resu">
                        ...
                        foreach (getAllTransaction() as $row) {
                            ...
                            <tr>
                                <td><?php echo $si; ?></td>
                                <td><img src="../images/user/<?php if(($user_details1['profile_image'] == NULL) || empty($user_details1['profile_image'])){  echo $footer_row['user_default_image'];}else{ echo $user_details1['profile_image']; } ?>" alt="" loading="lazy"><?php echo $user_details1['first_name']; ?><span><?php echo $user_details1['email_id']; ?></span><span>Join:<?php echo dateFormatconverter($user_details1['user_cdt']); ?></span>
                                </td>

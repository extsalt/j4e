                ...
                <div class="ud-cen-s2 ad-table-inn">
                    ...
                    <table class="responsive-table bordered">
                        ...
                        foreach (getAllInactiveAdsEnquiry() as $row) {
                            ...
                            <tr>
                                <td><?php echo $si; ?></td>
                                <td><a href="admin-user-full-details.php?row=<?php echo $user_details_row['user_id'];   ?>"><img src="../images/user/<?php echo $user_details_row['profile_image'];   ?>" alt="" loading="lazy"><?php
                                ...
                                <td><img src="../images/ads/<?php echo $row['ad_enquiry_photo']; ?>" alt="" loading="lazy"></td>

    ...
    <div class="ad-com pg-com">
        <div class="ad-dash leftpadd">
            <div class="ud-cen">
                <?php
                $expert_id = $_GET['row'];
                $row = getIdExpert($expert_id);
                ?>
                <form name="all_expert_form" id="all_expert_form" method="post" action="update_seo_expert.php"
                      enctype="multipart/form-data" class="cre-dup-form cre-dup-form-show">
                    <input type="hidden" class="validate" id="expert_id" name="expert_id"
                           value="<?php echo $row['expert_id']; ?>" required="required">
                    <div class="pg-cen">
                        <div class="s-com pg-tit">
                            <h1>Edit Service Expert SEO options</h1>
                            <?php include "../page_level_message.php"; ?>
                            <div class="form-group">
                                <input type="text" required="required" class="form-control" value="<?php echo $row['profile_name']; ?>"
                                       disabled>
                            </div>
                        </div>
                    ...
                    <div class="pg-rhs">
                        <div class="box pub">
                            ...
                            <div class="inn">
                                <ul>
                                    <li>
                                        <button type="submit" name="expert-seo-submit" class="btn-pub">Save changes</button>
                                    </li>
                                </ul>
                            </div>
                        </div>

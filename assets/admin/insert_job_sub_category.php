...
if (isset($_POST['sub_category_submit'])) {
    ...
    echo $cnt = count($_POST['sub_category_name']);
...
//************ sub_category Name Already Exist Check Starts ***************
        ...
        $sub_category_name_exist_check = mysqli_query($conn, "SELECT * FROM " . TBL . "job_sub_categories  WHERE sub_category_name='" . $sub_category_name . "' ");
...
//                $newLink = $link;
//                do {
//                    $checkLink = mysqli_query($conn, "SELECT sub_category_id FROM " . TBL . "job_sub_categories WHERE sub_category_slug = '$newLink'");
...
//        }
        ...
        $counter = 1;
        $checkLink = mysqli_query($conn, "SELECT sub_category_id FROM " . TBL . "job_sub_categories WHERE sub_category_slug = '$sub_category_name1'");
        if (mysqli_num_rows($checkLink) > 0) {
        ...
        $sql = mysqli_query($conn, "INSERT INTO  " . TBL . "job_sub_categories (sub_category_name,sub_category_status, sub_category_slug,category_id,sub_category_cdt)
VALUES ('$sub_category_name','$sub_category_status', '$sub_category_slug','$category_id','$curDate')");
        ...
        $upqry = mysqli_query($conn, "UPDATE " . TBL . "job_sub_categories 

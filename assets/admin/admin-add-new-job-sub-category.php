                ...
                <div class="container">
                    <div class="row">
                        <div class="login-main add-list add-ncate">
                            ...
                            <span class="udb-inst">New Job Sub Category</span>
                            <div class="log log-1">
                                <div class="login">
                                    <h4>Add New Job Sub Category</h4>
                                    ...
                                    <form  name="sub_category_form" id="sub_category_form" method="post" action="insert_job_sub_category.php" enctype="multipart/form-data" class="cre-dup-form cre-dup-form-show">
                                        <div class="row">
                                            <div class="col-md-12">

        ...
        <div class="ad-dash leftpadd">
            <div class="ud-cen">
                ...
                <div class="ud-cen-s2">
                    ...
                    <div style="display: none" class="static-success-message log-suc"><p>Event(s) has been Permanently Deleted!!! Please wait for automatic page refresh!! </p></div>
                    <a href="admin-add-new-event.php" class="db-tit-btn">Add new event</a>
                    <table class="responsive-table bordered" id="pg-resu">
                        ...
                        foreach (getAllEvents() as $eventrow) {
                            ...
                            <tr>
                                <td><?php echo $si; ?></td>
                                <td><?php echo $eventrow['event_name']; ?>
                                    <span><?php echo dateFormatconverter($eventrow['event_cdt']); ?></span></td>
                                ...
                                <td><span
                                        class="db-list-rat"><?php echo event_pageview_count($eventrow['event_id']); ?></span>
                                </td>
                                <td><a href="admin-edit-event.php?row=<?php echo $eventrow['event_id']; ?>"
                                       class="db-list-edit">Edit</a></td>
                                <td><a href="admin-delete-event.php?row=<?php echo $eventrow['event_id']; ?>"
                                       class="db-list-edit">Delete</a></td>
                                <td><a href="<?php echo $EVENT_URL . urlModifier($eventrow['event_slug']); ?>"
                                       class="db-list-edit" target="_blank">Preview</a></td>
                                <td><input type='checkbox' class='delete_check' id='delcheck_<?php echo $event_id; ?>' onclick='checkcheckbox();' value='<?php echo $event_id; ?>'></td>
                            </tr>
                            <?php
                            $si++;
                        }
        ...
        if(deleteids_arr.length > 0){
            ...
            if (confirmdelete == true) {
                $.ajax({
                    ...
                    type: 'post',
                    data: {request: 4,deleteids_arr: deleteids_arr},

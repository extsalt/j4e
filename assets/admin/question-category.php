    ...
    <section>
        <div class="ad-com">
            <div class="ad-dash leftpadd">
				...
				<span class="udb-inst">Question Categories</span>
                <div class="ud-cen-s2 hcat-cho">
                    <h2>All Question Categories</h2>
                    <?php include "../page_level_message.php"; ?>
                    <a href="question-add-new-category.php" class="db-tit-btn">Add new Category</a>
                    <table class="responsive-table bordered" id="pg-resu">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><a href="question-edit-category.php?row=<?php echo $row['category_id']; ?>" class="db-list-edit">Edit</a></td>

                ...
                <div class="container">
                    <div class="row">
                        <div class="login-main add-list add-ncate">
                            ...
                            <span class="udb-inst">Delete Job Sub Category</span>
                            <div class="log log-1">
                                <div class="login">
                                    <h4>Delete Job Sub Category</h4>
                                    <?php include "../page_level_message.php"; ?>
                                    <?php
                                    $sub_category_id=$_GET['row'];
                                    $row= getJobSubCategory($sub_category_id);

                                    ?>
                                    <form name="sub_category_form" id="sub_category_form" method="post" action="trash_job_sub_category.php" enctype="multipart/form-data" class="cre-dup-form cre-dup-form-show">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <select disabled="disabled" name="category_id" class="form-control" id="category_name">
                                                        <?php
                                                        foreach (getAllJobCategories() as $row_1) {
                                                            ?>
                                    ...
                                    <div class="col-md-12">
                                        <a href="admin-all-job-sub-category.php" class="skip">Go to All Job Sub Category >></a>
                                    </div>

...
class __TwigTemplate_7b8cebcb030ed1ca1a9f8726b7436162df3f65fff66a71878fd777d5d7210e3b extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Close");
    ...
    ";
            // line 51
            if ((1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["data"] ?? null), "errors", [], "any", false, false, false, 51)), 0))) {
                // line 52
...
echo _gettext("Errors occurred while executing rule expressions:");
    ...
    ";
            // line 62
            if ((1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["data"] ?? null), "fired", [], "any", false, false, false, 62)), 0))) {
                // line 63
                echo "      <h4>";
...
";
    ...
    {
        return new Source("", "server/status/advisor/index.twig", "/var/www/html/phpMyAdmin/templates/server/status/advisor/index.twig");
    }
}
